...
/** InputOnUpdate: Represents an input system update event. This event is invoked immediately following an update of the `InputSystem`
 *  * ***
 * Inherits: `MulticastAction`
 * @return {Struct.InputOnUpdate} */
function InputOnUpdate() : MulticastAction() constructor {
