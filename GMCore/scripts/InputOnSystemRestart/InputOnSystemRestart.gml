...
/** InputOnSystemRestart: This event is triggered when the game resets and can be used to cleanup or reinitialize components of the input system module.
 * ***
 * Inherits: `MulticastAction`
 * @return {Struct.InputOnSystemRestart} */
function InputOnSystemRestart() : MulticastAction() constructor {
