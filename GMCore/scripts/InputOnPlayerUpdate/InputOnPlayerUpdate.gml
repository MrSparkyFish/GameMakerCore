...
/** InputOnPlayerUpdate: Represents an input player update event
 * ***
 * Inherits: `MulticastAction`
 * @return {Struct.InputOnPlayerUpdate} */
function InputOnPlayerUpdate() : MulticastAction() constructor {
	 ...
	 * * `{Struct.InputPlayer}` *_player* The player that was updated
	 ...
	 * @arg {Struct.InputPlayer} _player The player that was updated
	 * @return {Undefined} */
