...
function TagQuery() constructor {
	...
	static Matches = function(tags) {
		...
		//switch (expression.expressionType) {
			//
			////Check for matches excluding tag parents
			//case Tag_QueryExpression.allTagsMatchExact:
				//return ArrayContainsAllValues(tags.tags, expression.tagList);
			//break;
			//
			////Check for matches excluding tag parents
			//case Tag_QueryExpression.anyTagsMatchExact:
				//return ArrayContainsAnyValue(tags.tags, expression.tagList);
			//break;
			//
			////Check for matches including tag parents
			//case Tag_QueryExpression.allTagsMatch:
				//var _tagList = expression.tagList;
				//var i = 0; repeat(array_length(_tagList)) {
					//if (!tags.HasTag(_tagList[i++])) {
						//return false;
					//}
				//}
				//return true;
			...
			//
			////Check for matches including tag parents
			//case Tag_QueryExpression.anyTagsMatch:
				//var _tagList = expression.tagList;
				//var i = 0; repeat(array_length(_tagList)) {
					//if (tags.HasTag(_tagList[i++])) {
						//return true;
			...
			//break;
			//
			////Check that no tags match
			//case Tag_QueryExpression.noTagsMatch:
				//var _tagList = expression.tagList;
				//var i = 0; repeat(array_length(_tagList)) {
					//if (tags.HasTag(_tagList[i++])) {
						//return false;
			...
			//break;
			//
			////Recursively check each expression to make sure all tags match
			//case Tag_QueryExpression.allExprMatch:
				//var _exprList = expression.expressionList;
				//var i = 0; repeat(array_length(_exprList)) {
					////Tags must match ALL expressions, so if one returns false we can early exit
					//var _expr = _exprList[i++];
					//if (!Matches(_expr, tags)) {
						//return false;
					//}
				//}
				//return true;
			//break;
			//
			////Recursively check each expression to make sure any tags match
			//case Tag_QueryExpression.anyExprMatch:
				//var _exprList = expression.expressionList;
				//var i = 0; repeat(array_length(_exprList)) {
					////Tags need to match only 1 expression, so early exit on the first match
					//var _expr = _exprList[i++];
					//if (Matches(_expr, tags)) {
						//return true;
					//}
			...
			//break;
			//
			////Recursively check each expression to make sure no tags match
			//case Tag_QueryExpression.noExprMatch:
				//var _exprList = expression.expressionList;
				//var i = 0; repeat(array_length(_exprList)) {
					////Tags cannot match any expression so return false on the first match
					//var _expr = _exprList[i++];
					//if (Matches(_expr, tags)) {
						//return false;
					//}
